...
public interface AchievementRecordMapper extends BiomedBaseMapper<AchievementRecord> {
    @Select("SELECT id, title, owner_name, source_module, course_id, course_title, batch_id, herb_name, project_title, standard_id, " +
            "category, level_name, score, evidence, evidence_file_ids, status, " +
